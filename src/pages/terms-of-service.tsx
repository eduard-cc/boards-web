...
export default function TermsOfService() {
  ...
  return (
    <>
      ...
      <div className="px-[27rem] pt-28 text-foreground">
        ...
        <h2 className="my-4 text-2xl font-semibold">1. Acceptance of Terms</h2>
        <p>
        ...
        <p>
          a. Users can create projects, manage memberships, and assign roles to
          members within a project.
          <br />
          b. Project owners and admins have the authority to add or remove
          members from a project and manage their roles.
          <br />
          c. Each member is responsible for adhering to the project's guidelines
          and permissions set by the project owner or admin.
        </p>
        ...
        <p>
          a. Users can personalize their profiles by adding a picture, updating
          their name, company, location, and email.
          <br />
        ...
        <p>
          a. Users will receive notifications for project invitations and issue
          assignments.
          <br />
        ...
        <p>
          a. Boards respects user privacy. Please review our Privacy Policy for
        ...
        <p>
          Boards may update or modify these Terms of Service from time to time.
          Users will be notified of significant changes, and continued use of
          the application after such modifications constitutes acceptance of the
          revised terms.
        </p>
