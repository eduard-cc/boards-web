  ...
  return (
    <>
      ...
      <div className="px-[27rem] pt-28 text-foreground">
        ...
        <p>
          Boards collects information provided by users during the registration
          process, including but not limited to name, email, picture, company,
          and location.
        </p>
        ...
        <h2 className="my-4 text-2xl font-semibold">3. Information Sharing</h2>
        <p>
          a. Boards may share user information with third-party service
          providers for the purpose of providing and enhancing the application's
          features.
          <br />
          b. User information will not be sold or disclosed to third parties for
